...
config.set('content.javascript.clipboard', 'access-paste', 'https://ukc-excel.officeapps.live.com')
...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///Users/nscott/Library/Application%20Support/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///Users/nscott/Library/Application%20Support/qutebrowser/userscripts/*')
