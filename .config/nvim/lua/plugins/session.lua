return {
    {
        ...
        opts = {
            ...
            session_lens = {
                ...
                picker_opts = { fullscreen = true, }, -- Table passed to Telescope / Snacks / Fzf-Lua to configure the picker. See below for more information
                ...
                mappings = {
                    ...
                    delete_session = { "i", "<C-BS>" }, -- mode and key for deleting a session from the picker
