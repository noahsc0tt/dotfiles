...
vim.keymap.set("n", "<M-d>", function() vim.cmd("bdelete!") end, { silent = true, noremap = true })
vim.keymap.set("n", "<M-S-d>", function() vim.cmd("bdelete! others") end, { silent = true, noremap = true })
vim.keymap.set("n", "<M-S-h>", function() bfline.move(-1) end, { silent = true })
vim.keymap.set("n", "<M-S-l>", function() bfline.move(1) end, { silent = true })
...
vim.keymap.set("n", "<M-q>", function() vim.cmd("FocusEqualise") end, { silent = true })
vim.keymap.set("n", "<M-f>", function() vim.cmd("ZenMode") end, { silent = true })
vim.keymap.set("n", "<M-t>", function() vim.cmd("FocusDisable") end, { silent = true })
