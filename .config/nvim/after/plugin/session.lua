...
vim.keymap.set("n", "<leader>sn", "<cmd>AutoSession search<CR>", { desc = "Session search", })
vim.keymap.set("n", "<leader>sd", "<cmd>AutoSession delete_picker<CR>", { desc = "Toggle autosave", })
...
vim.keymap.set("n", "<leader>sn", "<cmd>AutoSession disable<CR>", { desc = "Disable AutoSession", })
